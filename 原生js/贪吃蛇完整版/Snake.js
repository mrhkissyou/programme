...
(function (window) {
    ...
    function Snake(width,height,direction){//1.宽高;    2.身体(I.位置 II.颜色)  3.方向;
        ...
        this.body = [
            {top: 0,left: 2,color: "red"},//头
            {top: 0,left: 1,color: "orange"},//身体
            {top: 0,left: 0,color: "orange"} //身体
        ];
    ...
    Snake.prototype.snakeMove = function (map,food,snake) {
        //删除旧蛇画新蛇;
        removeSnake(map);
        ...
        if(headx == food.left && heady == food.top){
            ...
            this.count+=1;
            document.getElementsByTagName("i")[0].innerHTML = document.getElementsByTagName("i")[0].innerHTML*1+1;
            this.body.push(obj);
        }
